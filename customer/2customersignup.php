    ...
    <div class="sec1" style="display: flex; justify-content:center;">
        <div class="myform">
            <fieldset>
                ...
                <hr>
                <form action="<?php echo $url; ?>/customer/2customersignupcode.php" method="post">
                    ...
                    <a href="<?php echo $url; ?>/customer/2customerlogin.php" class="btn btn-success" style="float: right;">Back to Login</a>
                </form>
            </fieldset>
        </div>
    </div>
