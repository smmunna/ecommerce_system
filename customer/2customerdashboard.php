        ...
        <section id="sec1">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    ?>
                    <li style="background-color: green;"><a href="<?php echo $url; ?>/shopnow.php" style="color: black;">Shop Now</a></li>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="productlist">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            ?>
                                                <tr>
                                                    <td scope="row"><a class="invoi" href="2customerinvoice.php?id=<?php echo $row['product_id']; ?>">Invoice-<?php echo $count++; ?></a></td>
