<title>T-Shirt | Category</title>
    ...
    <div class="container">
        ...
        <h2 style="text-align: center; padding-top:90px">Shirt & T-Shirt List</h2>
        ...
        <div class="row">
            ...
            global $recv;
            $sql = "SELECT * FROM `products` WHERE `categoryid`='6' AND  `product_name` LIKE '%$recv%' ORDER BY product_id DESC LIMIT $page_first_result,12";
        ...
        <div style="display: flex;justify-content:center;">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    <?php
                    // For pagination -->
                    $sql1 = "SELECT * FROM `products` WHERE `categoryid`='6'";
                    ...
                    ?>
                        ...
                        <li class="page-item"><a class="page-link" href="http://localhost/All_Code/ecommerce_system/product_category/tshirt_category.php?page=<?php echo $target; ?>"><?php echo $target; ?></a></li>
