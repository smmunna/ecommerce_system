...
<body>
    ...
    <div class="container">
        ...
        <h2 style="text-align: center; padding-top:90px">Computer Accesories</h2>
        ...
        <div class="row">
            ...
            global $recv;
            $sql = "SELECT * FROM `products` WHERE `categoryid`='2' AND  `product_name` LIKE '%$recv%' ORDER BY product_id DESC LIMIT $page_first_result,12";
            ...
            ?>
                ...
                <div class="card" style="width: 18rem;margin: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="http://localhost/All_Code/ecommerce_system/productdetails.php?id=<?php echo $row['product_id']; ?>" class="btn btn-primary">Buy Now</a>
                    </div>
                </div>
        ...
        <div style="display: flex;justify-content:center;">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    <?php
                    // For pagination -->
                    $sql1 = "SELECT * FROM `products` WHERE `categoryid`='2'";
                    ...
                    <li class="page-item"><a class="page-link" href="http://localhost/All_Code/ecommerce_system/product_category/computer_accesories.php?page=<?php echo $target; ?>"><?php echo $target; ?></a></li>
