            ...
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    ?>
                        ...
                        <li class="page-item"><a class="page-link" href="http://localhost/All_Code/ecommerce_system/product_category/mobile_accessories.php?page=<?php echo $target; ?>"><?php echo $target; ?></a></li>
