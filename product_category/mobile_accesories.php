...
<body>
    ...
    <div class="container">
        ...
        <h2 style="text-align: center; padding-top:90px">Mobile Accesories</h2>
        ...
        <div class="row">
            ...
            global $recv;
            $sql = "SELECT * FROM `products` WHERE `categoryid`='1' AND  `product_name` LIKE '%$recv%' ORDER BY product_id DESC LIMIT $page_first_result,12";
        ...
        <div style="display: flex;justify-content:center;">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    <?php
                    // For pagination -->
                    $sql1 = "SELECT * FROM `products` WHERE `categoryid`='1'";
                    ...
                    ?>
                        ...
                        <li class="page-item"><a class="page-link" href="mobile_accesories.php?page=<?php echo $target; ?>"><?php echo $target; ?></a></li>
            ...
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    ?>
                        ...
                        <li class="page-item"><a class="page-link" href="<?php echo $url; ?>/product_category/mobile_accessories.php?page=<?php echo $target; ?>"><?php echo $target; ?></a></li>
