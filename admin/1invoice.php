        ...
        <div class="myform">
            <fieldset>
                ...
                <form action="" method="post">
                    ...
                    <input type="date" id="delivary" name="delivary"><br><br>
                    <br><br>
                    <button type="submit" class="btn btn-primary">Sent Invoice</button>
                    <a href="http://localhost/All_Code/ecommerce_system/admin/1admindashboard.php" class="btn btn-success" style="float: right;margin-left:15px;">Back to Dashboard</a>
                </form>
            </fieldset>
        </div>
    </div>
