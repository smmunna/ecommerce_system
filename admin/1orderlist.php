...
<body>
    ...
    <div class="container">
        ...
        <!-- Back to Dash Board -->
        <a href="http://localhost/All_Code/ecommerce_system/admin/1admindashboard.php" class="btn btn-success">Back to Dashboard</a>
        <a href="http://localhost/All_Code/ecommerce_system/admin/1orderlist.php" class="btn btn-primary" style="float: right;">Show All</a> <br><br>
    </div>
